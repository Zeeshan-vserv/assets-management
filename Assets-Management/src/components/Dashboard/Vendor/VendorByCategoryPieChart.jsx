...
function VendorByCategoryPieChart() {
  const valueFormatter = ({ value }) => `${value}`;

  const title = "Vendor By Category";
  const VendorByCategoryData = [
...
export default VendorByCategoryPieChart;
