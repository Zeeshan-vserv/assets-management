...
const csvConfig = mkConfig({
  ...
  filename: "Assets-Management-Publisher.csv",
});
...
function Publisher() {
  ...
  const deletePublisherHandler = async (e) => {
    e.preventDefault();
    try {
      const deletePublisherResponse = await deletePublisher(deletePublisherId);
  ...
  function handlePdfData() {
    ...
    doc.save("Assets-Management-Publisher.pdf");
  }
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-md:max-w-sm max-sm:max-w-xs p-8">
              ...
              <p className="text-gray-700 mb-6">
                This action will permanently delete the publisher.
              </p>
              <form
