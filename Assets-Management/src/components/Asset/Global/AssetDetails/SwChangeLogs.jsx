...
const csvConfig = mkConfig({
  ...
  filename: "Assets-Management-Sw-change-Logs.csv",
});

function SwChangeLogs({ id }) {
  const [data, setData] = useState([]);
  const [isLoading, setIsLoading] = useState(true);

  const fetchSwChangeLogs = async () => {
    try {
      setIsLoading(true);
  ...
  const handlePdfData = () => {
    ...
    doc.save("Assets-Management-Sw-change-Logs.pdf");
  };
