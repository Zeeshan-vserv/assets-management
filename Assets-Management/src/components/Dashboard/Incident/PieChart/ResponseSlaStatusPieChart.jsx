...
import { getResponseSlaStatus } from "../../../../api/DashboardRequest";

function ResponseSlaStatusPieChart() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const res = await getResponseSlaStatus(
  ...
  const title = "Response SLA Status";
...
export default ResponseSlaStatusPieChart;
