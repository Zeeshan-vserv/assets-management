...
//         setAssetsData(assetsResponse?.data?.data || []);
...
//                   {condition.conditionValue && condition.conditionValue !== "User is VIP" && (
//                     <div className="flex items-center min-w-[400px]">
//                       <label className="text-xs font-semibold w-32 text-slate-600">
...
//                         className="w-full text-xs border-b-2 border-slate-300 p-2 outline-none"
//                         type="text"
//                         value={getConditionFieldValue(condition, condition.conditionValue)}
//                         onChange={(e) =>
//                           setConditionFieldValue(index, condition.conditionValue, e.target.value)
//                         }
//                       /> */}
//                                     <Autocomplete
//                 className="w-[65%]"
...
//                 options: ["Severity-1", "Severity-2", "Severity-3", "Severity-4"],
//               },
//             ].map((field) => (
//               <div className="flex items-center w-[46%]" key={field.id}>
//                 <label className="w-[25%] text-xs font-semibold text-slate-600">{field.label}</label>
//                 <select
//                   className="w-[65%] text-xs border-b-2 border-slate-300 p-2 outline-none focus:border-blue-500"
//                   name={field.id}
...
//             <button
//               type="submit"
//               className="bg-[#2563eb] text-white py-2 px-4 rounded hover:bg-[#1e4fcc] transition-colors"
//             >
//               Submit Rule
//             </button>
//           </div>
