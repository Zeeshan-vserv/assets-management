...
const ReqSubCategory = () => {
          ...
          <IconButton
            onClick={() => {
              setDeleteInfo({
                ...
                subCategoryId: row.original._id,
              });
              setDeleteModal(true);
            }}
            color="error"
  ...
  const handleAddSubCategory = async (e) => {
    ...
    try {
      ...
      const res = await addServiceSubCategory(parent._id, {
  ...
  const handleEditSubCategory = async (e) => {
    e.preventDefault();
    try {
      const res = await updateServiceSubCategory(editForm._id, {
